...
export default function LecturerProfilePage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.error("Error parsing stored lecturer data:", e);
      router.push('/lecturer/login');
      return;
    }
  ...
  const instituteName = toTitleCase(instituteSlug);
  const departmentName = toTitleCase(departmentSlug);
  ...
  function handleSavePicture() {
    setLecturer(prev => {
      ...
      sessionStorage.setItem('lecturer', JSON.stringify(updated));
      return updated;
    });
    ...
    <div className="flex h-screen">
      ...
      <div className="flex-1">
        ...
        <div className="ml-64 mt-16 p-6 bg-gray-100 min-h-screen text-gray-900">
          <h1 className="text-3xl font-bold mb-6">{instituteName} - Lecturer Profile</h1>
